...
V17: File-level split + SpecAugment + CosineAnnealing + LabelSmoothing (데이터 누수 수정)
"""
import os
import numpy as np
import pandas as pd
...
# V17 클래스별 성능 (실측)
v17_per_class = {
    'Normal':   {'precision': 0.82, 'recall': 0.86, 'f1': 0.84},
    'Abnormal': {'precision': 0.85, 'recall': 0.83, 'f1': 0.84},
    'Unknown':  {'precision': 1.00, 'recall': 0.77, 'f1': 0.87},
}
...
ax2.text(8.5, 80, '+6.1%p\n(3-Class+PeakNorm)', ha='center', fontsize=10,
...
ax_t.axis('off')
ax_t.set_title('V1 vs V8 vs V17 — 핵심 성능 지표 비교 (File-Level Split, No Data Leakage)',
